...
function setup(){
	...
	//inicializa as posições x do p1 e x do p2

	p1_y =p2_y =(h/2)-(p_h/2)


	// inicializa pontos dos jogadores como 0

	p1_points = 0
	p2_points = 0

	// define intervalo de 6-fps para cada loop
...
function loop(){
	...
	//verifica se bola bateu no chão ou teto
...
function writePoints(){
	...
	ctx.fillStyle ="#fff";
	// w/4 =1/4 da tela(metade do player 1)
